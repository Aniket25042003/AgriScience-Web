    ...
    <div className="min-h-screen bg-gradient-to-br from-green-200 via-green-100 to-emerald-100 flex items-center justify-center px-4">
      <div className="fixed inset-0 opacity-10 pointer-events-none">
        <motion.div
          ...
          className="absolute top-32 right-32 w-36 h-36 bg-green-400 rounded-full blur-xl"
        />
        <motion.div
          animate={{ x: [0, 120, 0], y: [0, -70, 0] }}
          transition={{ duration: 28, repeat: Infinity, ease: "linear" }}
          className="absolute bottom-32 left-32 w-44 h-44 bg-green-300 rounded-full blur-xl"
        />
      </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600">Join AgriScience today</p>
        </div>
